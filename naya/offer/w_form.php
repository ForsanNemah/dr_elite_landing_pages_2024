...
<style>
  ...
  .btn-call {
    background-color: #00acb9; /* Red color for button */
    color: #fff;
...
حرقنا الاسعار لعيونكم
  ...
  <div class="btn-container" data-aos="fade-right" data-aos-duration="1500">
    <form action="w_app_notifi.php" method="POST" onsubmit="disableButtonOnSubmit2(this)">
      ...
      <input type="hidden" name="branch" value="   معلومات اكثر عن العرض    ">
      
      <input type="hidden" name="msg" value="whatsapp button click عيادة نايا">
      <input type="hidden" name="type" value="wapp">
  <input type="hidden" name="phone" value="966535106183">
