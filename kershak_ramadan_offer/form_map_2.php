...
<img src="ads/done.gif" class="img-fluid" width='100px' height='100px' alt="Responsive image"   >
                                ...
                                <form id="form" role="form"      method="post" name="myform" bgcolor=”#800000">
                                    ...
                                    <p contenteditable="true" class="appointment-title text-light">     
...
?>
                                    ...
                                    <p contenteditable="true" class="appointment-title text-light" style="font-size:1.2em;direction:rtl">   
...
?>
                            ...
                            <br />
                            <p contenteditable="true" class="text-light" style="font-size: 1.2em; font-size: 1.2em; font-family: inherit !important ">     
