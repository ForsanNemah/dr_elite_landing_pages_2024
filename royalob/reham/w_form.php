...
<style>
  ...
  .btn-call {
    background-color: #b07302; /* Red color for button */
    color: #fff;
...
<div class="container mt-5 text-center">
 ...
 احجز الان عبر واتساب واحصل على كشف مجاني 
  </h2>
  <h3>
  ...
  <!-- Form 1 -->
  <div mt-5 hidden class="btn-container" data-aos="fade-right" data-aos-duration="1500">
  ...
  <div  class="btn-container"  >
    <form action="w_app_notifi.php" method="POST" onsubmit="disableButtonOnSubmit2(this)">
      <input type="hidden" name="branch" value="      انقر هنا للحجز عبر واتساب  ">
      <input type="hidden" name="msg" value=" whatsapp button click     انقر هنا للحجز عبر واتساب    ">
      <input type="hidden" name="type" value="wapp">
      <input type="hidden" name="phone" value="966569946104">
