            ...
            <div class="st-footer-widget">
              <div class="st-text-field">
                ...
                <ul class="st-social-btn st-style1 st-mp0">
                  <li hidden><a target="_blank"  href="https://www.facebook.com/majaldental"><i class="fab fa-facebook-square"></i></a></li>

                  <li><a target="_blank" href="https://www.instagram.com/ebtisamaty/"><i class="fab fa-instagram-square"></i></></li>

                  <!-- <li><a href="http://twitter.com/jameelkhattab20"><i class="fab fa-twitter-square"></i></a></li>  -->

               
                  <li><a target="_blank" href="https://www.tiktok.com/@ebtisamaty">

                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-tiktok" viewBox="0 0 16 16">
  <p contenteditable="true"ath d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3z"/>
</svg>
