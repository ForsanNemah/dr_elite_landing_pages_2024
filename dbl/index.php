        ...
        <h1>ما يميزنا </h1>
          ...
          <div class="col-lg-4">
            <div class="st-iconbox st-style1">
              ...
              يستخدم المعمل التقنيات الحديثة والمواد عالية الجودة لضمان دقة التصنيع والملاءمة المثلى لتركيبات الأسنان. هذا يضمن رضا المرضى ويطيل عمر التركيبات.
          ...
          <div class="col-lg-4">
            <div class="st-iconbox st-style1">
              ...
              <h2 class="st-iconbox-title">التكنولوجيا المتقدمة</h2>
              <div class="st-iconbox-text">
                
              الاعتماد على التكنولوجيا المتقدمة مثل الطباعة ثلاثية الأبعاد وأنظمة التصميم بمساعدة الكمبيوتر (CAD) والتصنيع بمساعدة الكمبيوتر (CAM) لتحسين كفاءة العمليات وتحقيق نتائج دقيقة وشخصية لكل مريض.
          ...
          <div class="col-lg-4">
            <div class="st-iconbox st-style1">
              ...
              <h2 class="st-iconbox-title">  فريق من المتخصصين المؤهلين     </h2>
              <div class="st-iconbox-text">
                
              وجود فريق من الفنيين والخبراء المؤهلين والمدربين على أحدث التقنيات في مجال صناعة تركيبات الأسنان، مما يضمن تقديم أفضل خدمة وأعلى مستوى من العناية للمرضى.
        ...
        <div class="row">
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="st-funfact st-style1">
                  ...
                  <h2 class="st-funfact-number st-counter">5</h2>
                  <div class="st-funfact-title">سنوات خبرة</div>
                </div>
              ...
              <div class="col-lg-6">
                <div class="st-funfact st-style1">
                  ...
                  <h2 class="st-funfact-number st-counter">123</h2>
                  <div class="st-funfact-title">دكتور معتمد</div>
                </div>
                <div class="st-height-b30 st-height-lg-b30"></div>
              </div><!-- .col -->
              <div class="col-lg-6">
                <div class="st-funfact st-style1">
                  ...
                  <h2 class="st-funfact-number st-counter">45</h2>
          ...
          <div class="col-xl-6 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
            <div class="st-video-block st-style1 st-zoom">
              <div class="st-video-block-img st-zoom-in st-dynamic-bg" data-src="images/video-cover.jpeg"></div>
              <a href="<?php echo $video_url ?>?autoplay=1"
