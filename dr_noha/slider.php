  ...
  <section class="py-5 mt-4">
    <div class="container">
      ...
      <div class="row g-4">
        ...
        <?php
$folderPath = 'offers_index/'; // Replace 'path/to/folder' with the actual path to your folder
...
foreach ($imageFiles as $image) {
    ...
    <div class="col-md-6 col-lg-4  border border-3 rounded mb-4">
    <div class="card text-center">
      <img src="offers_index/'.$image.'" class="card-img-top mx-auto d-block" alt="Offer 1">
      <div class="card-body">
