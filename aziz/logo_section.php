...
if ($handle = opendir('logo')) {
 ...
 echo "  <h3><a style='color:blue'  href='https://maps.app.goo.gl/HhGzecPoC8iu3yb5A'>موقعنا على الخريطة </a></h3>";
 echo "  <h3><a style='color:blue'  href='#youtube_video'> فيديو تعريفي </a></h3>";
