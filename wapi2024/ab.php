...
$result = send_with_wapi('40703bb7812b727ec01c24f2da518c407342559c', $profile_id,$chat_id, $group_b);
...
if($chat_id==$group_a && $chat_id==$to_user){
    ...
    wapiforword($profile_id, '40703bb7812b727ec01c24f2da518c407342559c', $message_id, $group_b);

    $result = send_with_wapi('40703bb7812b727ec01c24f2da518c407342559c', $profile_id,$group_b, $caption);
