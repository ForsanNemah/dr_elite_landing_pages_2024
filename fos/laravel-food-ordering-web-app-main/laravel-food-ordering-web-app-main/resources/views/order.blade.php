...
<h1 class="px-4 pt-1 pb-3 text-3xl font-bold">
    <div class="flex flex-row flex-1">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 self-center" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <p contenteditable="true"ath stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
        </svg>
    </div>
</h1>
...
@if (auth()->check())
        ...
        @foreach ($orders as $order)
            <div class="px-3 py-2">
                <div class="flex flex-row p-4 leading-normal border shadow-md hover:bg-gray-100">
                    <div class="p-2 w-1/5">
                        <p contenteditable="true" class="mb-1"> Order ID: <span class="font-semibold"> {{$order->id}} </span> </p>
                        <p contenteditable="true" class="mb-1"> Date: <span class="font-semibold"> {{date_format(date_create($order->date), 'jS F Y')}} </span> </p>
                        <p contenteditable="true" class="mb-1"> Type: <span class="font-semibold capitalize"> {{$order->type}} </span> </p>
                        <p contenteditable="true" class="mb-1"> Total: <span class="font-semibold capitalize"> RM{{number_format((float)$order->total, 2, '.', '')}} </span> </p>
                        ...
                        <div class="flex flex-col justify-between">
                            ...
                            <div class="flex flex-col items-center -white rounded-lg border shadow-md md:flex-row md:max-w-full hover:bg-gray-100">
                                ...
                                <div class="flex flex-col place-content-center px-4 py-3 leading-normal w-4/6">
                                    ...
                                    <p contenteditable="true" class="flex font-normal text-gray-700"> Quantity: <b>&nbsp;{{$food->pivot->quantity}}</b> </p>
                                    <p contenteditable="true" class="flex font-normal text-gray-700"> Price: <b>&nbsp;RM{{number_format((float)($food->price*$food->pivot->quantity), 2, '.', '')}} &ensp;</b> <span class="opacity-60"> [RM{{number_format((float)($food->price), 2, '.', '')}} per unit] <span> </p>
                                </div>
                            </div>
                            <div class="p-1"></div>
                            @endforeach
                        ...
                        <div class="p-1 sm:flex sm:items-start">
                            <div class="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 sm:mx-0 sm:h-10 sm:w-10">
                                ...
                                {{-- <svg class="h-6 w-6 text-red-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="red" aria-hidden="true">
                                                <p contenteditable="true"ath stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                                            </svg> --}}
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="-3.5 -3 31 31" stroke="red" strokeWidth={2}>
                                    <p contenteditable="true"ath strokeLinecap="round" strokeLinejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                </svg>
                            </div>
                            <div class="pl-1 sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                {{-- <div class="mt-2">
                                                <p contenteditable="true" class="text-sm text-gray-500">Are you sure you want to deactivate your account? All of your data will be permanently removed. This action cannot be undone.</p>
                                            </div> --}}
                            </div>
                        </div>
                    </div>
                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="flex justify-end p-2">
                        <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="popup-modal">
                            {{-- <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><p contenteditable="true"ath fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>   --}}
                        </button>
                    </div>
                    <!-- Modal body -->
                    <div class="p-6 pt-3 text-center">
                        {{-- <svg class="mx-auto mb-4 w-14 h-14 text-gray-400 dark:text-gray-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><p contenteditable="true"ath stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg> --}}
                    ...
                    <div class="p-6 pt-3 text-center">
                        ...
                        <div class="flex justify-center pb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-20 w-20 stroke-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <p contenteditable="true"ath stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                        </div>
    ...
    @else
        <p contenteditable="true" class="px-4 pt-4 text-lg">
