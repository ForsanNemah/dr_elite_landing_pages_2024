    ...
    <div class="flex flex-row">
        <div class="flex flex-row flex-1">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 self-center" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <p contenteditable="true"ath stroke-linecap="round" stroke-linejoin="round" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
            </svg>
        </div>
            ...
            <div class="flex flex-col justify-between">
                <div class="flex flex-col items-center bg-white rounded-lg border shadow-md md:flex-row md:max-w-full hover:bg-gray-100">
                    ...
                    <div class="flex flex-col place-content-center px-4 py-3 leading-normal w-4/6">
                        ...
                        <p contenteditable="true" class="flex font-normal text-gray-700"> Quantity: <b>&nbsp;{{$food['quantity']}}</b> </p>
                        <p contenteditable="true" class="flex font-normal text-gray-700"> Price: <b>&nbsp;RM{{number_format((float)($food['price']*$food['quantity']), 2, '.', '')}} &ensp;</b> <span class="opacity-60"> [RM{{number_format((float)($food['price']), 2, '.', '')}} per unit] <span> </p>
                    </div>
            ...
            <form method="POST" action="/cart/placeorder" class="px-4 pt-2 pb-4" name="place-order-form" id="place-order-form">
                ...
                <div class="p-6 flex-grow">
                    ...
                    <div class="hidden" id="address_div">
                        ...
                        @endif
                        <span class="">
                            <p contenteditable="true" id="addresserr" class="text-red-600"></p>
                        </span>
                    </div>
                </div>
