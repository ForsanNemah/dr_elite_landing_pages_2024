...
<div class="mt-5 container-fluid" id="service1_id">
        ...
        return `
            <div class="col-sm-6 col-md-3 package-col mainbg2" data-aos="zoom-in-up">
                <div class="package">
                    ...
                    <a href="#myform">
<button class="mb-2 btn booking-btn-class " data-href1="${service.dataHref1}" data-href2="${service.dataHref2}">حجز موعد</button>
                    </a>
