...
if($api_notification==1){
    ...
    $result = send_with_wapi('9f9151b56d756354026b368ecc644edec19343b4', 'a0aca078-18a5', $phone_main.'@c.us',  $w_app_msg3);
     ...
     $result = send_with_wapi('9f9151b56d756354026b368ecc644edec19343b4', 'a0aca078-18a5',$group_id.'@g.us',  $w_app_msg2);
...
*/
     ...
     $result = send_with_wapi('9f9151b56d756354026b368ecc644edec19343b4', 'a0aca078-18a5',$group_id.'@g.us',  $w_app_msg3);
...
$result = send_with_wapi('9f9151b56d756354026b368ecc644edec19343b4', 'a0aca078-18a5',$phone.'@c.us', $message_to_customer);
