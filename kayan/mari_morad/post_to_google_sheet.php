...
if($api_notification==1){
    ...
    $w_app_msg3=$w_app_msg2." خدمة   ".$service." lp mari morad";
...
/*
    $result = send_with_wapi('9f9151b56d756354026b368ecc644edec19343b4', 'a0aca078-18a5', '120363301321001980@g.us',  $w_app_msg3);
